...
#Funcion para simulacion pn=1, pr=0 dimension=100 
rm(list=ls())
mini_val_pn_1_pr_0<-function(G){
  mr<-10
  mn<-10
  pr<-0
  pn<-1
...
mini_val_pn_1_pr_0(G)

#Simulaciones para pn=1 y dimension=100
data_pn_1_pr_0_dim_100<-cbind(sapply(1:10000, mini_val_pn_1_pr_0))



#Funcion para simulacion pn=1, pr=1 dimension=100 
#rm(list=ls())
mini_val_pn_1_pr_1<-function(G){
  mr<-10
  mn<-10
  pr<-1
  pn<-1
...
mini_val_pn_1_pr_1(G)

#Simulaciones para pn=1 y dimension=100
data_pn_1_pr_1_dim_100<-cbind(sapply(1:10000, mini_val_pn_1_pr_1))

#Funcion para simulacion pn=0, pr=1 dimension=100 
#rm(list=ls())
mini_val_pn_0_pr_1<-function(G){
  mr<-10
  mn<-10
  pr<-1
  pn<-0
...
mini_val_pn_0_pr_1(G)

#Simulaciones para pn=1 y dimension=100
data_pn_0_pr_1_dim_100<-cbind(sapply(1:10000, mini_val_pn_0_pr_1))

data_100<-cbind(data_pn_1_pr_0_dim_100, data_pn_1_pr_1_dim_100, data_pn_0_pr_1_dim_100)

colnames(data_100) <- c("Pref. Attach. pn=1; pr=0", "Hybrid pn=1; pr=1", "Unif. Random pn=0; pr=1")


write.xlsx(data_100, "wd_100.xlsx")
